            ...
            <ScrollView>
              <View style={styles.viewPadding}>
                <Button
                  ...
                  onPress={() => setLocation('addhouse')}>
                  Add House
                </Button>
                {houses &&
                  Object.values(myHouses).map((house, index) => (
                    <HouseComponent owner={true} key={index} available={true} info={house} />
                  ))}
              </View>
            </ScrollView>
          </View>
